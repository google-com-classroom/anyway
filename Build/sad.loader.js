function createUnityInstance(t, n, l) {
    ...
    u.QuitCleanup = function() {
        for (var e = 0; e < u.deinitializers.length; e++)
            u.deinitializers[e]();
        u.deinitializers = [],
        "function" == typeof u.onQuit && u.onQuit()
    }
    ;
    var h, m, b, g, p, w, v, y, k, _ = {
        Module: u,
    ...
    b = "RequestStore",
    g = "WebAssembly",
    p = window.indexedDB || window.mozIndexedDB || window.webkitIndexedDB || window.msIndexedDB,
    w = null,
                ...
                var t, n = {
                    ...
                    "zlib/inflate.js": function(e, t, n) {
                        ...
                        n.inflate = function(e, t) {
                            var n, r, o, a, i, s, l, c, d, u, f, h, m, b, g, p, w, v, y, k, _, x, S, C, E = 0, U = new T.Buf8(4), D = [16, 17, 18, 0, 8, 7, 9, 6, 10, 5, 11, 4, 12, 3, 13, 2, 14, 1, 15];
                            ...
                            e: for (; ; )
                                ...
                                case 19:
                                    for (; n.have < n.nlen + n.ndist; ) {
                                        for (; p = (E = n.lencode[c & (1 << n.lenbits) - 1]) >>> 16 & 255,
                                        w = 65535 & E,
                                        !((g = E >>> 24) <= d); ) {
                                            if (0 === s)
                                                break e;
                                ...
                                case 21:
                                    ...
                                    for (n.back = 0; p = (E = n.lencode[c & (1 << n.lenbits) - 1]) >>> 16 & 255,
                                    w = 65535 & E,
                                    !((g = E >>> 24) <= d); ) {
                                        if (0 === s)
                                            break e;
                                    ...
                                    if (p && 0 == (240 & p)) {
                                        for (v = g,
                                        y = p,
                                        k = w; p = (E = n.lencode[k + ((c & (1 << v + y) - 1) >> v)]) >>> 16 & 255,
                                        w = 65535 & E,
                                        !(v + (g = E >>> 24) <= d); ) {
                                            if (0 === s)
                                                break e;
                                ...
                                case 22:
                                    ...
                                    n.mode = 23;
                                case 23:
                                    for (; p = (E = n.distcode[c & (1 << n.distbits) - 1]) >>> 16 & 255,
                                    w = 65535 & E,
                                    !((g = E >>> 24) <= d); ) {
                                        if (0 === s)
                                            break e;
                                    ...
                                    if (0 == (240 & p)) {
                                        for (v = g,
                                        y = p,
                                        k = w; p = (E = n.distcode[k + ((c & (1 << v + y) - 1) >> v)]) >>> 16 & 255,
                                        w = 65535 & E,
                                        !(v + (g = E >>> 24) <= d); ) {
                                            if (0 === s)
                                                break e;
                    ...
                    "zlib/inffast.js": function(e, t, n) {
                        ...
                        t.exports = function(e, t) {
                            var n, r, o, a, i, s, l = e.state, c = e.next_in, d = e.input, u = c + (e.avail_in - 5), f = e.next_out, h = e.output, m = f - (t - e.avail_out), b = f + (e.avail_out - 257), g = l.dmax, p = l.wsize, w = l.whave, v = l.wnext, y = l.window, k = l.hold, _ = l.bits, x = l.lencode, S = l.distcode, C = (1 << l.lenbits) - 1, E = (1 << l.distbits) - 1;
                            e: do {
                                for (_ < 15 && (k += d[c++] << _,
                                _ += 8,
                                k += d[c++] << _,
                    ...
                    "zlib/inftrees.js": function(e, t, n) {
                        ...
                        t.exports = function(e, t, n, r, o, a, i, s) {
                            for (var l, c, d, u, f, h, m, b, g, p = s.bits, w = 0, v = 0, y = 0, k = 0, _ = 0, x = 0, S = 0, C = 0, E = 0, U = 0, D = null, B = 0, A = new I.Buf16(16), T = new I.Buf16(16), R = null, P = 0, w = 0; w <= 15; w++)
                                A[w] = 0;
                            for (v = 0; v < r; v++)
                                A[t[n + v]]++;
                            for (_ = p,
                            ...
                            0 === k)
                                ...
                                for (; ; ) {
                                    ...
                                    0),
                                    l = 1 << (m = w - S),
                                    y = c = 1 << x; o[f + (U >> S) + (c -= l)] = m << 24 | b << 16 | g | 0,
                                    0 !== c; )
                                        ;
                                    for (l = 1 << w - 1; U & l; )
                                        l >>= 1;
